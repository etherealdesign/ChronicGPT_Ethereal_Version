...
const BuildForTrust = () => (
  <div className='build-for-trust h-[90lvh] bg-transparent rounded-[30px] lg:rounded-[54px] overflow-hidden flex flex-col border border-[5px] border-white '>
    ...
    <div className='text-left flex-1 flex flex-col lg:justify-center gap-[14px] sm:gap-[24px] px-[10px] py-[18px] sm:py-[24px] lg:p-[24px]sm:pb-[32px] @media(width:768px)_and_(height:1024px)]:mt-[90px]'>
      <div className='text-left text-[34px] lg:text-[36px] w-[92%] mx-auto font-semibold max-[380px]:text-[24px]'>Built for Trust</div>
      <div className='text-[16px] flex flex-col gap-[8px] w-[92%] mx-auto'>
        <div className='w-full font-medium max-[380px]:text-[13px] text-[15px] leading-[20px] lg:text-[16px] lg:leading-normal xl:leading-[35px] 2xl:leading-[40px] [@media(width:768px)_and_(height:1024px)]:leading-[40px] @media(width:768px)_and_(height:1024px)]:w-[80%]  '>
        ...
        <div className='w-full font-medium max-[380px]:text-[13px] text-[15px] leading-[20px] lg:text-[16px] lg:leading-normal [@media(width:768px)_and_(height:1024px)]:leading-[40px] [@media(width:768px)_and_(height:1024px)]:w-[80%] m-auto xl:leading-[40px] 2xl:leading-[40px]'>
